...
class People:
    ...
    def __init__(self):
        ...
        try:
            ...
            print("there are {} people registered".format(
                len(self.List_Of_People)
                ))
        except:
...
class Person:
    ...
    def __str__(self):
        ...
        return ("{}, {}, {}, {}, {}, {}, {}, {}".format(
            self.Name, self.Sur, self.Address,
...
def Send_Data():
    ...
    User = Person(
            Name_Text.get(), Last_Name_Text.get(), Address_Text.get(),
            Email_Text.get(), Phone_Text.get(), Cell_Text.get(),
            District_Text.get(), Country_Text.get()
           )
